...
using manager.web.api.bootstrap;
using manager.web.api.infrastructure.filters;
using manager.web.api.infrastructure.middlewares;
using manager.web.api.integrationevents.eventhandling;
using manager.web.api.integrationevents.events;
using manager.web.api.model;
using manager.web.api.repository;
using manager.web.api.service;
