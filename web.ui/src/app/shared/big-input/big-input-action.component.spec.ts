...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<darkninja-big-input-action></darkninja-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<darkninja-big-input-action [disabled]="true"></darkninja-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<darkninja-big-input-action fontSet="fas" fontIcon="fa-trash"></darkninja-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<darkninja-big-input-action label="delete"></darkninja-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<darkninja-big-input-action (action)="actionHandler()"></darkninja-big-input-action>`;
    fixture = createHostComponent(template);
