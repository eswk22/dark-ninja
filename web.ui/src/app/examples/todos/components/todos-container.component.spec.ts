...
describe('TodosComponent', () => {
  ...
  beforeEach(async () => {
    component = await createComponent('<darkninja-todos></darkninja-todos>', {
  ...
  it('should dispatch add todo action', () => {
    ...
    component.keyUp(
      component.getByPlaceholderText('darkninja.examples.todos.input'),
      {
        target: {
          value: 'poke Tomas'
        }
    ...
    expect(
      (component.getByPlaceholderText(
        'darkninja.examples.todos.input'
